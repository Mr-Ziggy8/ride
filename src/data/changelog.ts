...
export const CHANGELOG: ChangelogEntry[] = [
  {
    dateIso: '2026-07-31',
    summary:
      "Nouvelle identité graphique, menu animé (tap extérieur pour fermer sans changer d'écran), chargement GPX déplacé dans le menu, limite de 10 commentaires actifs, échantillonnage GPS plus fin pour des tracés fluides, écran d'accueil en cartes avec aperçu de tes stats, déblocage Premium (paiement unique Stripe ou code promo), gestion des rôles pour les admins.",
  },
  {
    dateIso: '2026-07-30',
