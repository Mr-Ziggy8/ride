...
export const CHANGELOG: ChangelogEntry[] = [
  {
    dateIso: '2026-07-31',
    summary:
      "Nouvelle identité graphique, menu animé (tap extérieur pour fermer), chargement GPX déplacé dans le menu, retour toujours vers l'accueil, limite de 5 commentaires actifs, échantillonnage GPS plus fin pour des tracés fluides, écran d'accueil en cartes avec aperçu de tes stats, déblocage Premium (paiement unique Stripe ou code promo).",
  },
  {
    dateIso: '2026-07-30',
